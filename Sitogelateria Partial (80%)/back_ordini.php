...
<div><!-- div contenitore tabella ordini -->
    ...
    <!-- chiusura tabella ordini -->
    <button type="text" class="btn btn-default col-lg-5 col-md-5 col-sm-4 col-xs-4" value="nuovo ordine"><a
            href="formgelato.php">nuovo ordine</button>
</div>
<!-- chiusura div contenitore tabella utenti -->
