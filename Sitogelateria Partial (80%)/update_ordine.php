        ...
        <div class="row">
            <div class="col-sm-5 col-lg-5">
                <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" id="citta"
                           placeholder="Inserisci la citt&agrave...">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-5 col-lg-5">
                <div class="form-group">
                    ...
                    <input name="gelato" type="text" class="form-control" id="gelato"
                           placeholder="Seleziona la tipologia di gelato...">
                </div>
            </div>
        </div>
        <div class="row">
