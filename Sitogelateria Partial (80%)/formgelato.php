        ...
        <tr>
            ...
            <td>
                <input type="text" name="cognome"
                       value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['cognome']; ?>"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="citta"
                       value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['citta']; ?>"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="indirizzo"
                       value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['indirizzo']; ?>"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="cap" value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['cap']; ?>"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="telefono"
                       value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['telefono']; ?>"
                       onkeypress="return onlyNumeric(event);" maxlength="10"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="email" name="email" value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['email']; ?>"
                       placeholder="indirizzo@dominio.en"/>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="time" name="ora" min="10:00" max="23:00"
                       value="<?php if (isset($_SESSION['nome'])) echo $_SESSION['ora']; ?>"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <fieldset>
                    ...
                    <div id="menu1" style
                    "display:none";>
                    Coppetta<a onclick="javascript:fToggle('elenco1');"><input type="radio" name="gelato"
                                                                               value="coppetta"></a>
